# Code for NQUEENS as direct implementation of Genetic Algorithm (No optimization done)
import random
import time
import numpy
...
MAX_FITNESS = 29
THRESHOLD = 0.10    # mutation probability = 10%
...
# [1076, 7068, 1934, 4267, 1152] -> Average generations required = 