...
class Knowledge_Base(object):
    ...
    def __init__(self):
        ...
        self.const = False
        self.kb = list()
        self.kb.extend([[-711] , [-723, -113, -712,] , [-732, -133, -734] , [-813, -712] , [-822, -732] , [713, 733, 722, -423] , [-734, -133, -723] , [-724, -134, -733] , [712, 714, -413] , [712, 723, 721, -422] , [-723, -133, -743] , ])
        ...
        self.kb.extend([[712, -111, 721] , [-734, -144, -743] , [712, -113, 723, 714] , [-732, -133, -743] , [742, 744, -443] , [814, 713, 724] , [-831, -721] , [-822, -721] , [841, 742, 731] , [823, 722, 724, 713, 733] , ])
        self.kb.extend([[-812, -722] , [-814, -713] , [-724, -123, -713] , [413, -712, -714, -723] , [711, -121, 731, 722] , [-824, -723] , [-833, -734] , [713, 733, 724, -423] , [733, -134, 744, 724] , [-721, -122, -723] , ])
        self.kb.extend([[-723, -122, -732] , [-841, -742] , [-814, -724] , [821, 722, 731, 711] , [-722, -121, -711] , [742, -111, 731] , [831, 732, 721, 741] , [822, 721, 723, 712, 732] , [-732, -142, -743] , [733, 744, -443] , ])
        self.kb.extend([[711, 722, -412] , [-833, -732] , [-721, -122, -732] , [-832, -733] , [733, 742, 731, -432] , [-821, -731] , [442, -741, -743, -732] , [722, 713, -412] , [721, -411] , [-731, -132, -742] , ])
        ...
        self.kb.extend([[732, 721, -431] , [-844, -743] , [-744] , [733, 744, -434] , [-833, -723] , [-831, -741] , [724, -414] , [-723, -122, -712] , [741, 732, -442] , [-744, -143, -742] , ])
        self.kb.extend([[732, 743, -442] , [-741, -131, -732] , [-831, -732] , [-843, -742] , [-811, -712] , [-813, -714] , [741, -142, 732, 743] , [834, 724, 733, 744] , [713, -414] , [731, -441] , ])
...
def dfs(tempagent, node, goal, depth, path , g):
    ...
    if node == goal:
        print()
        print("Optimal path from src to dest (without showing backtracked nodes) :- ")
        print_path(path);
        return True
